...
//	分页查询
	...
	public String jiaoshixinxiList(@RequestParam(value="page",required=false)String page,
			ModelMap map,HttpSession session,Jiaoshixinxi jiaoshixinxi, String gonghao, String mima, String xingming, String xingbie, String shenfenzheng, String dianhua, String banji, String beizhu){
