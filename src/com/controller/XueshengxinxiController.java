...
@RequestMapping("updateXueshengxinxi2.do")
	...
	@RequestMapping("doUpdateXueshengxinxilb.do")
	public String doUpdateXueshengxinxilb(int id,ModelMap map,Xueshengxinxi xueshengxinxi){
		xueshengxinxi=xueshengxinxiService.getById(id);
		map.put("xueshengxinxi", xueshengxinxi);
		return "xueshengxinxi_updtlb";
	}
	
@RequestMapping("updateXueshengxinxilb.do")
	public String updateXueshengxinxilb(int id,ModelMap map,Xueshengxinxi xueshengxinxi){
		xueshengxinxiService.updatelb(xueshengxinxi);
		return "redirect:xueshengxinxiList.do";
	}
...
//	分页查询
	...
	public String xueshengxinxiList(@RequestParam(value="page",required=false)String page,
			ModelMap map,HttpSession session,Xueshengxinxi xueshengxinxi, String xuehao, String mima, String xingming, String xingbie, String shenfenzheng, String dianhua, String banji, String kunnanleibie, String beizhu, String issh){
	...
	@RequestMapping("xueshengxinxiList2.do")
	public String xueshengxinxiList2(@RequestParam(value="page",required=false)String page,
			ModelMap map,HttpSession session,Xueshengxinxi xueshengxinxi, String xuehao, String mima, String xingming, String xingbie, String shenfenzheng, String dianhua, String banji, String kunnanleibie, String beizhu, String issh,HttpServletRequest request){
