...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
		...
		<tr ><td width="200">学校审核：</td><td><select name='xuexiaoshenhe' id='xuexiaoshenhe'><option value="审核通过">审核通过</option><option value="不符合申请资格">不符合申请资格</option></select></td></tr>
		<tr ><td width="200">困难类别：</td><td><input name='kunnanleibie' type='text' id='kunnanleibie' value='' onblur='' style='border:solid 1px #000000; color:#666666' /></td></tr>
