...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="addKunnanshengshenqing.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">添加困难生申请</td>
						</tr>
		...
		<tr style='display:none'><td width="200">教师审核：</td><td><select name='jiaoshishenhe' id='jiaoshishenhe'><option value="待审">待审</option><option value="审核通过">审核通过</option></select></td></tr>
		<tr style='display:none'><td width="200">学院审核：</td><td><select name='xueyuanshenhe' id='xueyuanshenhe'><option value="待审">待审</option><option value="审核通过">审核通过</option></select></td></tr>
		<tr style='display:none'><td width="200">学校审核：</td><td><select name='xuexiaoshenhe' id='xuexiaoshenhe'><option value="待审">待审</option><option value="审核通过">审核通过</option></select></td></tr>
