...
-->
			  ...
			  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="kunnanshengshenqingList2.do" name="myform" method="post">
    ...
    <td align='center'>${u.issh} </td>
                              ...
                              <td align="center"><a href="doUpdateKunnanshengshenqinglb2.do?id=${u.id }">审核</a>    <a href="kunnanshengshenqingDetail.do?id=${u.id }">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
		 ...
		 <c:if test="${page.page>1}">
              <a href="kunnanshengshenqingList2.do?page=1" >首页</a>
             <a href="kunnanshengshenqingList2.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="kunnanshengshenqingList2.do?page=${page.page+1 }">下一页</a>
			<a href="kunnanshengshenqingList2.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
