	...
	<body>
			<form action="updateZhuxuejin.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">设置助学金<input type="hidden" name="id" value="${zhuxuejin.id}" /></td>
						</tr>
		...
		<tr ><td width="200">学校审核：</td><td><select name='xuexiaoshenhe' id='xuexiaoshenhe'><option value="通过">通过</option><option value="不通过">不通过</option></select></td></tr>
		<tr ><td width="200">助学金额：</td><td><input name='zhuxuejine' type='text' id='zhuxuejine' value='' onblur='' style='border:solid 1px #000000; color:#666666' /></td></tr>
