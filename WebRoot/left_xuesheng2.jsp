...
<tr>
      ...
      <td class="SystemLeft"><a href="doUpdateXueshengxinxi2.do" target="hsgmain">修改个人资料</a></td>
    </tr>
...
<table cellpadding="0" cellspacing="0" width="167" align="center">
  <tr>
    <td height="28" class="menu_title" onMouseOver="this.className='menu_title2'" onMouseOut="this.className='menu_title'" background="images/admin_left_01.gif" id="menuTitle1" onClick="collapse('submenu6')" style="cursor:pointer;"><span class="SystemLeft">助学金管理</span></td>
  </tr>
  <tr>
...
<tr>
      <td width="36" height="22"></td>
      <td class="SystemLeft"><a href="zhuxuejin_add.jsp" target="hsgmain">助学金添加</a></td>
    </tr>

<tr>
      <td width="36" height="22"></td>
      <td class="SystemLeft"><a href="zhuxuejinList2.do" target="hsgmain">助学金查询</a></td>
    </tr>
...
<table cellpadding="0" cellspacing="0" width="167" align="center">
  <tr>
    <td height="28" class="menu_title" onMouseOver="this.className='menu_title2'" onMouseOut="this.className='menu_title'" background="images/admin_left_01.gif" id="menuTitle1" onClick="collapse('submenu13')" style="cursor:pointer;"><span class="SystemLeft">勤工助学管理</span></td>
  </tr>
  <tr>
    <td style="display:none" align="right" id="submenu13"><div class="sec_menu" style="width:165">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" background="images/SysLeft_bg_link.gif">
	
<tr>
      <td width="36" height="22"></td>
      <td class="SystemLeft"><a href="gangweixinxi_yanben1.do" target="hsgmain">勤工助学添加</a></td>
    </tr>

<tr>
      <td width="36" height="22"></td>
      <td class="SystemLeft"><a href="qingongzhuxueList2.do" target="hsgmain">勤工助学查询</a></td>
    </tr>
...
<table cellpadding="0" cellspacing="0" width="167" align="center">
  <tr>
    <td height="28" class="menu_title" onMouseOver="this.className='menu_title2'" onMouseOut="this.className='menu_title'" background="images/admin_left_01.gif" id="menuTitle1" onClick="collapse('submenu10')" style="cursor:pointer;"><span class="SystemLeft">工作管理</span></td>
  </tr>
  <tr>
...
<tr>
      <td width="36" height="22"></td>
      <td class="SystemLeft"><a href="gongzuojiluxinxiList2.do" target="hsgmain">工作查询</a></td>
    </tr>
