...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateGongzuojiluxinxi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改工作记录信息<input type="hidden" name="id" value="${gongzuojiluxinxi.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.bumenzhanghao.value='${gongzuojiluxinxi.bumenzhanghao}';</script>	<script language="javascript">document.form1.bumenmingcheng.value='${gongzuojiluxinxi.bumenmingcheng}';</script>	<script language="javascript">document.form1.gangwei.value='${gongzuojiluxinxi.gangwei}';</script>	<script language="javascript">document.form1.xuehao.value='${gongzuojiluxinxi.xuehao}';</script>	<script language="javascript">document.form1.xingming.value='${gongzuojiluxinxi.xingming}';</script>	<script language="javascript">document.form1.xingbie.value='${gongzuojiluxinxi.xingbie}';</script>	<script language="javascript">document.form1.gongzuojilu.value='${gongzuojiluxinxi.gongzuojilu}';</script>	
					 </table>
			</form>
   </body>
</html>
