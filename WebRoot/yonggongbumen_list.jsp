...
-->
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td colspan="17" background="images/table_header.gif">用工部门列表</td>
						</tr>
					</table>
				</td>
			</tr>
				...
				%>
                            <tr align="center" bgcolor="#FFFFFF">
                             ...
                             <td>${u.bumenzhanghao}</td>    <td>${u.mima}</td>    <td>${u.bumenmingcheng}</td>    <td>${u.fuzeren}</td>    <td>${u.lianxidianhua}</td>    <td>${u.dizhi}</td>    
                              ...
                              <td align="center"><a href="doUpdateYonggongbumen.do?id=${u.id }">编辑</a>  <a href="deleteYonggongbumen.do?id=${u.id }"
										onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a> <a href="yonggongbumenDetail.do?id=${u.id}">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
		 ...
		 <c:if test="${page.page>1}">
              <a href="yonggongbumenList.do?page=1" >首页</a>
             <a href="yonggongbumenList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="yonggongbumenList.do?page=${page.page+1 }">下一页</a>
			<a href="yonggongbumenList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
