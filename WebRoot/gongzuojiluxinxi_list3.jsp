...
-->
			  ...
			  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="gongzuojiluxinxiList2.do" name="myform" method="post">
    ...
    <td>${u.gongzuojilu}</td>
    <td align='center'><a href="sh5.jsp?id=${u.id}&tablename=gongzuojiluxinxi">${u.issh}</a></td><td>${u.shhf}</td>
                              <td align="center"> ${u.addtime } </td>
                              <td align="center"><a href="doUpdateGongzuojiluxinxi.do?id=${u.id }">编辑</a>  <a href="deleteGongzuojiluxinxi.do?id=${u.id }"
										onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a> <a href="gongzuojiluxinxiDetail.do?id=${u.id }">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
		 ...
		 <c:if test="${page.page>1}">
              <a href="gongzuojiluxinxiList2.do?page=1" >首页</a>
             <a href="gongzuojiluxinxiList2.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="gongzuojiluxinxiList2.do?page=${page.page+1 }">下一页</a>
			<a href="gongzuojiluxinxiList2.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
