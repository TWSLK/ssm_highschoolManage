...
<tr>
      ...
      <td class="SystemLeft"><a href="doUpdateXueyuan2.do" target="hsgmain">修改个人资料</a></td>
    </tr>
...
<table cellpadding="0" cellspacing="0" width="167" align="center">
  <tr>
    <td height="28" class="menu_title" onMouseOver="this.className='menu_title2'" onMouseOut="this.className='menu_title'" background="images/admin_left_01.gif" id="menuTitle1" onClick="collapse('submenu4')" style="cursor:pointer;"><span class="SystemLeft">困难生申请管理</span></td>
  </tr>
  <tr>
...
<tr>
      <td width="36" height="22"></td>
      <td class="SystemLeft"><a href="kunnanshengshenqingList4.do" target="hsgmain">困难生申请查询</a></td>
    </tr>
...
<tr>
      <td width="36" height="22"></td>
      <td class="SystemLeft"><a href="zhuxuejinList3.do" target="hsgmain">助学金查询</a></td>
    </tr>
...
<tr>
      <td width="36" height="22"></td>
      <td class="SystemLeft"><a href="gangweixinxiList3.do" target="hsgmain">岗位查询</a></td>
    </tr>
...
<tr>
      <td width="36" height="22"></td>
      <td class="SystemLeft"><a href="qingongzhuxueList.do" target="hsgmain">勤工助学查询</a></td>
    </tr>
