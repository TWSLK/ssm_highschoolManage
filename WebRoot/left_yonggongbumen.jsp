...
<tr>
      ...
      <td class="SystemLeft"><a href="doUpdateYonggongbumen2.do" target="hsgmain">修改个人资料</a></td>
    </tr>
...
<table cellpadding="0" cellspacing="0" width="167" align="center">
  <tr>
    <td height="28" class="menu_title" onMouseOver="this.className='menu_title2'" onMouseOut="this.className='menu_title'" background="images/admin_left_01.gif" id="menuTitle1" onClick="collapse('submenu8')" style="cursor:pointer;"><span class="SystemLeft">岗位管理</span></td>
  </tr>
  <tr>
...
<tr>
      <td width="36" height="22"></td>
      <td class="SystemLeft"><a href="gangweixinxi_add.jsp" target="hsgmain">岗位添加</a></td>
    </tr>

<tr>
      <td width="36" height="22"></td>
      <td class="SystemLeft"><a href="gangweixinxiList2.do" target="hsgmain">岗位查询</a></td>
    </tr>
...
<table cellpadding="0" cellspacing="0" width="167" align="center">
  <tr>
    <td height="28" class="menu_title" onMouseOver="this.className='menu_title2'" onMouseOut="this.className='menu_title'" background="images/admin_left_01.gif" id="menuTitle1" onClick="collapse('submenu12')" style="cursor:pointer;"><span class="SystemLeft">勤工助学管理</span></td>
  </tr>
  <tr>
    <td style="display:none" align="right" id="submenu12"><div class="sec_menu" style="width:165">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" background="images/SysLeft_bg_link.gif">
	
<tr>
      <td width="36" height="22"></td>
      <td class="SystemLeft"><a href="qingongzhuxueList4.do" target="hsgmain">勤工助学查询</a></td>
    </tr>
...
<tr>
      <td width="36" height="22"></td>
      <td class="SystemLeft"><a href="gongzuojiluxinxiList3.do" target="hsgmain">工作查询</a></td>
    </tr>
